...
<head>
    ...
    <meta content="Purvanchal Cricket Association" name="description" />
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    ...
                                    <h1 class="text-white"><b>Purvanchal Cricket Association </b></h1>
                                </a>
                            </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Purvanchal Cricket Association</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form id="login_form">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                ...
                                </script> Purvanchal Cricket Association. Crafted with <i
