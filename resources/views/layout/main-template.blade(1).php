        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{url('dashboard')}}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{url('frontend/images/logo/logo.jpg')}}" alt="" height="25" />
                        <h3 class="text-white mt-4">Purvanchal Cricket Association</h3>
                    </span>
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown {{Request::is('category') || Request::is('amendment') || Request::is('photo') || Request::is('video') || Request::is('news') || Request::is('email')? 'show' :''}} " id="sidebarApps">
