               ...
               <div class="container">
                   <div class="row row-cols-1 row-cols-lg-2 g-lg-5">
                        <div class="col position-relative">
                            ...
                            <img src="{{url('frontend/images/pexels-photo-2973104.jpg')}}" alt="pic">
                            </figure>
                            <figure class="small-img">
                                <img src="{{url('frontend/images/pexels-photo-13464804.jpg')}}" alt="pic2">
                            </figure>
                        </div>
                        <div class="col">
              ...
              <div class="container">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="yd-hom1" role="tabpanel" >
                         <div class="comon-fild-ads1 d-lg-flex align-items-center">
                              <figure>
                                  <img src="{{url('frontend/images/pexels-photo-2973104.jpg')}}" alt="bg"/>
                              </figure>
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel">
                  <div class="container">
                    <div class="comon-fild-ads1 d-lg-flex align-items-center">
                      <figure>
                          <img src="{{url('frontend/images/pexels-photo-12806375.webp')}}" alt="bg"/>
                      </figure>
          ...
          <div class="container">
            ...
            <span class="bgi-text light-tsext01"> Staff</span>
              ...
              <div class="mangemnet-sf owl-carousel owl-theme">
                   <div class="items-man">
                      <figure>
                          <img src="{{url('frontend/images/manages-st.jpg')}}" alt="pmg"/>
                      </figure>
                      <div class="name">
                        <h5> Jores Leperto
                   ...
                   <div class="items-man">
                        <figure>
                            <img src="{{url('frontend/images/manages-st2.jpg')}}" alt="pmg"/>
                        </figure>
                        <div class="name">
                            <h5> Jores Leperto
                    ...
                    <div class="items-man">
                        <figure>
                            <img src="{{url('frontend/images/manages-st3.jpg')}}" alt="pmg"/>
                        </figure>
                        <div class="name">
                            <h5> Jores Leperto
                    ...
                    <div class="items-man">
                        <figure>
                            <img src="{{url('frontend/images/manages-st4.jpg')}}" alt="pmg"/>
                        </figure>
                        <div class="name">
                            <h5> Jores Leperto
              ...
              <span class="bgi-text light-tsext01"> Award  </span>
               ...
               <div class="achivent-slide owl-carousel owl-theme ">
                   <div class="items-achiv">
                       <figure>
                          <img src="{{url('frontend/images/award-img1.png')}}" alt="ad1"/>
                       </figure>
                   ...
                   <div class="items-achiv">
                    <figure>
                       <img src="{{url('frontend/images/award-img3.png')}}" alt="ad1"/>
                    </figure>
                    <div class="achiv-titel">
                    ...
                    <div class="items-achiv">
                        <figure>
                           <img src="{{url('frontend/images/award-img4.png')}}" alt="ad1"/>
                        </figure>
                        <div class="achiv-titel">
