...
<body>
 <header class="float-start w-100">
   ...
   <nav class="navbar navbar-expand-lg navbar-light nav_bar_pcb_wrap" style="flex-wrap: wrap;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown {{Request::is('mens_team') || Request::is('womens_team') ? 'show' : ''}}">
              ...
              <div class="dropdown-content">
                <ul>
                  <!--<li> <a class="nav-link" href="{{url('mens_team')}}">Sr. Men’s Team</a></li>-->
                  <!--<li> <a class="nav-link" href="{{url('womens_team')}}">Sr. Women’s Team</a></li>-->
     ...
     <!--   <div class="d-flex">-->
     <!--     <div class="purvanchal_logo text-center align-self-center">-->
     <!--       <a class="navbar-brand py-0" href="index">-->
     <!--         <img src="{{url('frontend/images/logo/logo.jpg')}}" alt="logo" class="img-fluid" />-->
     <!--         <p>CIN No : U92410UP2019NPL122877</p>-->
     <!--       </a>-->
     <!--     </div>-->
     <!--<div class="Association_nametext align-self-center text-center ">-->
     <!--       <div class=" purvanchal_logotext text-center">Purvanchal Cricket Association-->
     <!--       </div>-->
     <!--       <div class="company_regd_act_text"> A Company Regd. Under Section 8 Of The Compaies Act, 2013</div>-->
     <!--       <div class="adtext_cricekt_association">-->
     <!--         <b>Add:</b> C-19/6 Near Badshah Bagh Colony, Lallapur, Varanasi (U.P.) 221010 <br>-->
     <!--         <b>Addistional Correspondence address:</b> 10/60, vikash nagar, lucknow <br>-->
     <!--         <b>phone:</b> 9140842379, 9415086657, 9405880457, 8115117332 <br>-->
     <!--         <b>Email:</b> Purvanchalcricketassociation@gmail.com <br>-->
     <!--         <b>visit us:</b><a href="#"> Purvanchalcricketassociation.com</a>-->
     <!--       </div>-->
     <!--       <div class="collapse navbar-collapse" id="navbarSupportedContent">-->
     <!--     <ul class="navbar-nav mx-auto mb-2 mb-lg-0">-->
     <!--       <li class="nav-item {{Request::is('home') ? 'show' : ''}}">-->
              ...
              <div class="col">
                <div class="d-flex align-items-center">
                  ...
                  <div class="get-intouch-div  d-flex align-items-center justify-content-between">
                    <ul>
                      <li>
                        <a href="https://www.facebook.com/purvanchalcricketassociation/" class="btn btn-socal-1" target="_blank"><span>FOLLOW US ON FACEBOOK</span>
  ...
  <div class="offcanvas-body">
    ...
    <!-- </div>-->
     ...
     <a class="navbar-brand py-0 d-flex logo-side" href="index">
          <img src="{{url('frontend/images/logo/logo.jpg')}}" alt="logo" class="img-fluid"/><div class="text-uppercase align-self-center text-green logo-text">Purvanchal Cricket Association</div>
        </a> 
   ...
   <ul>
    ...
    <li class="nav-item {{Request::is('articles') ? 'show' : ''}}">
      ...
      <!--    <ul>-->
      <!--      <li> <i class="fab fa-whatsapp"></i> <span><a href="tel:7309994326" target="_blank" > +91 73099 94326  </a> </span> </li>-->
      <!--      <li> <i class="fas fa-envelope"></i> <span> <a href="mailto:purvanchalcricketassociation@gmail.com">purvanchalcricketassociation@gmail.com</a></span> </li>-->
      <!--    </ul>-->
      <!--  </div>-->
      <!--  <ul class="side-media">-->
      <!--   <li> <a href="https://www.facebook.com/purvanchalcricketassociation/" target="_blank"> FOLLOW US ON FACEBOOK </a> </li>-->
