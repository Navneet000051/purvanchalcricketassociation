                  ...
                  <div class="row">
                    <div class="col-lg-7">
                      <div class="header-content">
                        <h1 class="fadeInDown animated">We Look up, <span class="d-block"> Never Give Up
...
<section class="float-start w-100 body-part pt-0">
  ...
  <div class="top-list-turnament">
    ...
    <div class="mediasection d-inline-block w-100">
        <div class="container">
          ...
          <div class="row row-cols-2 row-cols-lg-4 mt-0 g-4 mt-3">
             <div class="col">
                <a data-fancybox="wk" href="{{url('frontend/images/pexels-photo-3628912.jpg')}}" class="comon-links-divb05">
                   <figure>
                      <img src="{{url('frontend/images/pexels-photo-3628912.jpg')}}" alt="pbnm"/>
                      <figcaption>
                        FGC CUP 2022
                      </figcaption>
                   </figure>
             ...
             <div class="col">
              <a data-fancybox="wk" href="images/pexels-photo-13509963.jpg" class="comon-links-divb05">
                 <figure>
                    <img src="{{url('frontend/images/pexels-photo-13509963.jpg')}}" alt="pbnm"/>
                    <figcaption>
                      FGC CUP 2022
                    </figcaption>
                 </figure>
            ...
            <div class="col">
              <a data-fancybox="wk" href="{{url('frontend/images/Centurion-Cricket-Academy-Andheri-8.webp')}}" class="comon-links-divb05">
                 <figure>
                    <img src="{{url('frontend/images/Centurion-Cricket-Academy-Andheri-8.webp')}}" alt="pbnm"/>
                    <figcaption>
                      FGC CUP 2022
                    </figcaption>
                 </figure>
            ...
            <div class="col">
              <a data-fancybox="wk" href="images/pexels-photo-5739195.jpg" class="comon-links-divb05">
                 <figure>
                    <img src="{{url('frontend/images/pexels-photo-5739195.jpg')}}" alt="pbnm"/>
                    <figcaption>
                      FGC CUP 2022
                    </figcaption>
                 </figure>
            ...
            <div class="col">
              <a data-fancybox="wk" href="images/Jonny-Bairstow-batting-semifinal-match-England-Australia-2019.webp" class="comon-links-divb05">
                 <figure>
                    <img src="{{url('frontend/images/Jonny-Bairstow-batting-semifinal-match-England-Australia-2019.webp')}}" alt="pbnm"/>
                    <figcaption>
                      FGC CUP 2022
                    </figcaption>
                 </figure>
            ...
            <div class="col">
              <a data-fancybox="wk" href="images/3364.webp" class="comon-links-divb05">
                 <figure>
                    <img src="{{url('frontend/images/3364.webp')}}" alt="pbnm"/>
                    <figcaption>
                      FGC CUP 2022
                    </figcaption>
                 </figure>
            ...
            <div class="col">
              <a data-fancybox="wk" href="images/pexels-photo-13509632.jpg" class="comon-links-divb05">
                 <figure>
                    <img src="{{url('frontend/images/pexels-photo-13509632.jpg')}}" alt="pbnm"/>
                    <figcaption>
                      FGC CUP 2022
                    </figcaption>
                 </figure>
            ...
            <div class="col">
              <a data-fancybox="wk" href="images/954603-658494-india-women-cricket-team-bcci.jpg" class="comon-links-divb05">
                 <figure>
                    <img src="{{url('frontend/images/954603-658494-india-women-cricket-team-bcci.jpg')}}" alt="pbnm"/>
                    <figcaption>
                      FGC CUP 2022
                    </figcaption>
                 </figure>
       ...
       <div class="container">
        ...
        <div class="team-membern owl-carousel owl-theme mt-5">
            <a href="player-details.html" class="crm-teams01">
               <figure>
                  <img src="{{url('frontend/images/t1.webp')}}" alt="teams01" />
               </figure>
               <div class="design">
               <h5> James dane</h5>
               <p> Offensive Line </p>
    ...
    <div class="sponcer-logo d-inline-block w-100">
      <div class="rtck-img">
         <img src="{{url('frontend/images/favpng_cricket-bats-kookaburra-sport-bag-cricket-clothing-and-equipment.png')}}" alt="bnm"/>
      </div>
       <div class="container">
          <div class="mindle-heading text-center">
          ...
          <div class="sponj-slide owl-carousel owl-theme mt-5">
              <div class="corm-iteml">
                  <figure class="m-auto">
                     <img src="{{url('frontend/images/brand_food2.jpg')}}" alt="jok"/>
                  </figure>
              </div>
              <div class="corm-iteml">
                <figure class="m-auto">
                   <img src="{{url('frontend/images/logo-3-1.png')}}" alt="jok"/>
                </figure>
              </div>
