          ...
          <form action="{{url('updateAmendment')}}" class="form-control" id="form1" name="form1" method="post" enctype="multipart/form-data">
            ...
            <form action="{{url('addAmendment')}}" class="form-control" id="form1" name="form1" method="post" enctype="multipart/form-data">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-4">
                  <label for="exampleInputdate" class="form-label">Appointment Date<span class="text-danger">*</span></label>
                ...
                <div class="col-lg-10">
                  ...
                  <textarea class="form-control" type="text" id="description" name="description" value="{{old('description' )}}">{{$edit_amendment ? $edit_amendment->description : ''}}</textarea>
