...
<body>
  ...
  <header class="float-start w-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        <a class="navbar-brand py-0 d-flex" href="{{url('home')}}">
          ...
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                <ul>
                  <li> <a class="nav-link" href="{{url('aims_object')}}">Aim & Object</a></li>
                  <li> <a class="nav-link " href="{{url('pca_mission')}}">PCA Mission</a></li>
                  <li> <a class="nav-link" href="{{url('pca_constitution')}}">PCA Constitution</a></li>
                  <li> <a class="nav-link" href="">Districts</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                <ul>
                  <li> <a class="nav-link" href="{{url('news_cutting')}}">News Cutting</a></li>
                  <li> <a class="nav-link" href="{{url('news_videos')}}">News Video</a></li>
                  <li> <a class="nav-link" href="{{url('videos')}}">Media</a></li>
                  <li> <a class="nav-link" href="{{url('photos')}}">Photos</a></li>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-content">
                <ul>
                  ...
                  <li> <a class="nav-link" href="{{url('about')}}">National</a></li>
