  ...
  <div class="col-md-12 ">
    <div class="card ">
      <div class="card-header">
        <a href="{{url('category')}}" class="btn btn-primary right">Category Add </a>
      </div>
    </div>
  </div>
  @else
    ...
    <div class="card">
      <div class="card-body">
        <div class="live-preview">
          ...
          @if($category_edit)
          <form action="{{url('updateCategory')}}" class="form-control" id="form1" name="form1" method="post" enctype="multipart/form-data">
            <div class="card">
            ...
            @else
            <form action="{{url('addCategory')}}" class="form-control" id="form1" name="form1" method="post" enctype="multipart/form-data">
              <div class="card">
                <div class="card-header align-items-center d-flex card-primary">
              ...
              <div class="row g-3">
                ...
                <div class="col-lg-6">
                  ...
                  <input type="hidden" class="form-control" id="id" name="id" value="{{$category_edit ? $category_edit->id : ''}}">
                  <input type="text" class="form-control" id="name" name="name" value="{{old('name',$category_edit ? $category_edit->name : '' )}}" placeholder="Enter name">
                ...
                <div class="col-lg-6">
                  ...
                  @if($category_edit)
                  <input type="file" class="form-control " id="imageS" name="imageS" value="{{old('image',$category_edit ? $category_edit->image : '')}}" accept="image/png, image/jpeg,image/jpg">
                  <img src="{{url('uploadCat/').'/'.($category_edit ? $category_edit->image :' ' ) }}" id="image-preview" style="height:30px;width:30px;">
                  @else
...
<script>
  function deleteData(id) {
    ...
    $('#deleteId').attr("href", "deleteCategory" + id)
  }
</script>
@section('external-js')
