    ...
    <div class="blogs-page d-inline-block w-100">
        <div class="container">
             ...
             <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-5 mt-0">
                <div class="col">
                    <a href="{{'url('blog_details')}}" class="comon-posrt w-100 d-inline-block">
                ...
                <div class="col">
                    <a href="{{'url('blog_details')}}" class="comon-posrt w-100 d-inline-block">
                        <div class="img-boxv w-100 d-inline-block">
                          <figure class="w-100 d-inline-block">
                              <img src="{{url('frontend/images/istockphoto-1158435344-612x612.jpg')}}" alt="pbnm">
                          </figure>
                          <span class="daet01">
                            10
                ...
                <div class="col">
                    <a href="{{'url('blog_details')}}" class="comon-posrt w-100 d-inline-block">
                        <div class="img-boxv w-100 d-inline-block">
                          <figure class="w-100 d-inline-block">
                              <img src="{{url('frontend/images/pexels-photo-1103829.jpg')}}" alt="pbnm">
                          </figure>
                          <span class="daet01">
                            05
                            <small class="d-block">Mar</small>
                ...
                <div class="col">
                    <a href="{{'url('blog_details')}}" class="comon-posrt w-100 d-inline-block">
                        <div class="img-boxv w-100 d-inline-block">
                          <figure class="w-100 d-inline-block">
                              <img src="{{url('frontend/images/pexels-photo-9148548.jpg')}}" alt="pbnm">
                          </figure>
                          <span class="daet01">
                            02
                            <small class="d-block">Jun</small>
